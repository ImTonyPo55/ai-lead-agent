...
NOISE_PATTERNS = [
    ...
    re.compile(
        r"\b(?:founder|cofounder|co-founder|ceo|cmo|cto|cpo|owner|director|marketing lead|growth lead|основатель|сооснователь|фаундер|владелец|директор|fundador|cofundador|dueño|dueno|directora)\b",
        re.IGNORECASE,
    ),
    re.compile(
